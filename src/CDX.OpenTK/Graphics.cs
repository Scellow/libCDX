...
namespace CDX.GLFWBackend
{
    ...
    public class Graphics : IGraphics, IDisposable
    {
        ...
        {
            string versionstring  = Gl.CurrentVersion.ToString(); //Gl.GetString(Gl.CurrentVersion);
            string vendorstring   = GL.CurrentVendor;             //Gl.GetString(Gl.GL_VENDOR);
            string rendererstring = GL.CurrentRenderer;           //Gl.GetString(Gl.GL_RENDERER);
