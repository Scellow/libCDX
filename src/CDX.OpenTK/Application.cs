...
namespace CDX.GLFWBackend
{
    public class Application : IApplication
    {
        ...
        {
            Window window = new Window(listener, config);
        ...
        static global::GLFW.GLFW.Window createGlfwWindow(ApplicationConfiguration config, global::GLFW.GLFW.Window? sharedContextWindow)
        {
            ...
            if (config.useGL30)
            {
                GLFW.GLFW.WindowHint(GLFW.GLFW.Hint.ContextVersionMajor, config.gles30ContextMajorVersion);
                GLFW.GLFW.WindowHint(GLFW.GLFW.Hint.ContextVersionMinor, config.gles30ContextMinorVersion);
            ...
            global::GLFW.GLFW.Window windowHandle = default(global::GLFW.GLFW.Window);
        ...
        {
            String versionString  = Gl.CurrentVersion.ToString(); //GL11.glGetString(GL11.GL_VERSION);
            String vendorString   = Gl.CurrentVendor;             //GL11.glGetString(GL11.GL_VENDOR);
            String rendererString = Gl.CurrentRenderer;           //GL11.glGetString(GL11.GL_RENDERER);
